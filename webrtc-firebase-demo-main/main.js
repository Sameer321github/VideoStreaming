...
// const SPEAK_TIME = 60;
// const FREE_TALK_TIME = 60; // initial free talk
// const DELAY_TIME = 10;
...
// // Add these buttons to your HTML too (shown below)
...
//   startCountdown(SPEAK_TIME, updatePhaseTimer, startDelay);
// }

// function startDelay() {
//   debateState.phase = 'delay';
//   setMic(localStream, true); // both can speak freely during delay
//   endArgumentButton.disabled = true;
...
//   setMic(localStream, false); // mute speaker 1 (local)
